        ...
        <div className="mx-auto max-w-7xl md:max-w-5xl">
          <div className="flex items-center justify-between gap-4 rounded-xl border border-ink/10 bg-white px-4 py-3 shadow-sm sm:px-5 lg:px-6">
            ...
            <div className="hidden lg:flex items-center gap-7">
              ...
              <a href="/contact">
                <span className="focus-ring inline-flex items-center gap-2 rounded-lg bg-primary px-5 py-2.5 font-body text-sm font-medium text-white transition-opacity hover:opacity-90">
